/*WAP to find solution of Non-Linear equations by Regula-Falsi Method.*/
#include <iostream>
#include <cmath>
#include <iomanip>
#include <cstring>
...
{
    double y_1,y_2;
    y_1 = 3*x_1+sin(x_1)-pow(e,x_1);//Put your function here
    y_2 = 3*x_2+sin(x_2)-pow(e,x_2);//Put your function here
    x = (y_2*x_1 - y_1*x_2)/(y_2-y_1);
    y = 3*x+sin(x)-pow(e,x);//Put your function here
